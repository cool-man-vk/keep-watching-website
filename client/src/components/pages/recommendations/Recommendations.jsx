            ...
            setLoadingtrue()
                ...
                try{
                    ...
                    if (recommender_type=== "userBasedCF"){
                        console.log("making pst request to 'https://keep-watching.onrender.com/recommendations/usercolaborativefiltering'")
                        res = await axios.post('https://keep-watching.onrender.com/recommendations/usercolaborativefiltering', data, config)
                    }else{
                        console.log("making pst request to 'https://keep-watching.onrender.com/recommendations/itemcolaborativefiltering'")
                        res = await axios.post('https://keep-watching.onrender.com/recommendations/itemcolaborativefiltering', data, config)
                    }
